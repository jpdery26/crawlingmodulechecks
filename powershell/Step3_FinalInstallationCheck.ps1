...
If ($valid) {
  ...
  writeln "Step 5. FAILED, MySql has problems, re-install." Red
  $failures = $true
}
writeln "========================================="
...
If ($valid) {
  ...
  writeln "Step 6. FAILED, MySql has problems, re-install." Red
  $failures = $true
}
writeln "========================================="
...
if ($failures) {
  writeln ""
  writeln "========================================================================="
  writeln "! You have failures, fix them first before adding content. !" Red
  writeln "========================================================================="
  writeln ""
  ...
  writeln ""
  writeln "You have no failures, proceed with adding content!." Green
